          ...
          <div class="w-full p-8 lg:w-1/2 ">
            <div class="mt-4">
              <label class="block text-black text-sm font-bold mb-2">Email</label>
                <asp:TextBox ID="EmailTxt" runat="server" class="bg-lightgray text-black focus:outline-none focus:shadow-outline border rounded py-2 px-4 block w-full appearance-none" type="email" MaxLength="100" />
            ...
            <div class="mt-4">
              ...
              <asp:TextBox ID="PasswordTxt" runat="server" class="bg-lightgray  text-black focus:outline-none focus:shadow-outline border rounded py-2 px-4 block w-full appearance-none" type="password" MaxLength="100" />
            ...
            <div class="mt-8">
                <asp:Button ID="SubmitBtn" Text="LOGIN" runat="server" CssClass="bg-ashblue text-white font-bold py-2 px-4 w-full rounded hover:bg-gray-600" OnClick="SubmitBtn_Click" />
            </div>
          </div>
        </div>
    </form>
